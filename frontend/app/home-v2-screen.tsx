...
/**
 * TRIAL — Instructor Home, from the same Claude Design handoff as
 * lesson-diary-v2-screen (23 Aug 2026). Separate route; the live
 * home-screen.tsx is untouched.
 *
 * Notable: this is wired to REAL data throughout. The current live home
 * screen still calls mockDb.getKPIs(), getMTDStats(), listTodayLessons()
 * and getEarningsByMonth() — meaning its student counts, month-to-date
 * earnings, today's lessons and the whole earnings chart are hardcoded
 * demo numbers, not the signed-in instructor's actual figures. New hooks
 * (useTodayLessons, useInstructorEarnings) were added for this.
 */
