...
/**
 * TRIAL — Sign In, from the same Claude Design handoff as
 * lesson-diary-v2-screen and home-v2-screen (23 Aug 2026). Separate route;
 * the live sign-up-login-screen.tsx is untouched.
 *
 * Every real auth behaviour from the source screen is preserved exactly:
 * the invite-token base64 decode + locked name/email fields, the Sign In /
 * Register segmented tabs, password reveal, the same validation ORDER
