...
/**
 * TRIAL — Student Profile, from the same Claude Design handoff (23 Aug
 * 2026). Separate route; the live student-lifecycle-screen.tsx (the
 * biggest, most-layered screen in the app) is untouched.
 *
 * The handoff's own comment says it covers "the same content blocks that
 * screen renders" — but checked against the real source, it was missing
 * three genuinely real, working features that were built later in this
 * session: the GDPR pending-deletion banner, customizable instructor
 * lesson notes, and the "Request a Google review" button. Flagged and
 * confirmed with Grant before building — all three are included below,
 * using the new visual language, not left out to match the design exactly.
 *
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 6 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 40 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 7 }}>
              <TouchableOpacity
                style={s.amendBtn}
                onPress={() => router.push({ pathname: '/student-crm-screen', params: { edit: student.id } } as any)}
                testID="v2-amend"
              >
            ...
            <>
              ...
              <View style={s.card}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <TouchableOpacity style={s.editBtn} onPress={() => router.push({ pathname: '/student-crm-screen', params: { edit: student.id } } as any)} testID="v2-edit-notes">
              ...
              <View style={s.card}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <TouchableOpacity style={s.logTestBtn} onPress={() => router.push({ pathname: '/student-crm-screen', params: { logTest: student.id } } as any)} testID="v2-log-test">
